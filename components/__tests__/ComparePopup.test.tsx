...
describe('ComparePopup', () => {
  ...
  describe('Same Country-Year Validation', () => {
    it('should show warning when trying to select same country-year combination', () => {
      ...
      expect(
        screen.queryByText('✅ Select This Country'),
    ...
    it('should allow selection when different country-year combination', () => {
      ...
      expect(
        screen.queryByText('⚠️ Cannot compare the same country and year'),
      ).not.toBeInTheDocument();
    });
  ...
  it('should show loading state', () => {
    ...
    expect(
      screen.getByText(/Generating AI comparison between/),
    ).toBeInTheDocument();
  });
  ...
  it('should show comparison result', () => {
    ...
    expect(
      screen.getByText('This is a test comparison result.'),
    ).toBeInTheDocument();
  ...
  it('should handle country name clicks in results', () => {
    ...
    expect(ReactGA4.event).toHaveBeenCalledWith(
      'ai_comparison_country_navigate',
      {

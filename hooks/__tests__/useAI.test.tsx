...
describe('useAIData', () => {
  ...
  it('should handle quota exceeded errors', async () => {
    const mockResponse = {
      ...
      json: vi.fn().mockResolvedValue({
        content: '',
        error:
          'AI service has reached its daily quota limit. Please try again tomorrow or switch to Wikipedia for historical information.',
      }),
    };
  ...
  it('should handle timeout errors', async () => {
    global.fetch = vi
      .fn()
      .mockRejectedValue(new Error('AbortError: Request timeout'));
